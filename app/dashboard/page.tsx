...
export default function DashboardOverview() {
  ...
  const checklistSteps = [
    ...
    { label: "Browse content templates", href: "/dashboard/templates", completed: false },
  ];
    ...
    <div className="space-y-8">
      ...
      {!isLoading && isNewUser ? (
        ...
        <>
          ...
          {/* Streak & Activity for active users */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <StreakCard currentStreak={0} longestStreak={0} totalPosts={analytics?.stats?.totalPublished || 0} />
            <ActivityHeatmap postsByDate={{}} />
          </div>
        </>
      )}
    </div>
