...
// I refactored SignInPage into a general wrapper for any auth flow, maintaining the particle canvas!
export const AuthCanvasWrapper = ({
  className,
  children,
  successState = false,
}: {
  ...
  return (
    <div className={cn("flex w-[100%] flex-col min-h-screen relative bg-[#030303]", className)}>
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        {/* Reverse canvas (appears when successfully authenticated/code complete) */}
        {successState && (
          <div className="absolute inset-0">
            <CanvasRevealEffect
              animationSpeed={4}
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(0,0,0,1)_0%,_transparent_100%)] opacity-20" />
        <div className="absolute top-0 left-0 right-0 h-1/3 bg-gradient-to-b from-[#030303] to-transparent mix-blend-multiply" />
      </div>
